...
def generate_launch_description():
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("agv_car_description"), "description", "final_agv_car.xacro"]
            ),
        ]
    )
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("agv_car_description"), "rviz", "bicbot.rviz"]
    )
    ...
    twist_mux_params = os.path.join(get_package_share_directory('agv_car_description'), 'config', 'twist_mux.yaml')
    twist_mux = Node(
        package='twist_mux',
